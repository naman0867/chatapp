...
const server = app.listen(port, () => console.log(`Application R
createWebSocketServer(server); 
app.use(express.static(path.join(__dirname, "..", "frontend", "d
app.get('/*', (req, res) => {
res.sendFile(path.join(__dirname, '../frontend/dist/index.ht
if (err) {
