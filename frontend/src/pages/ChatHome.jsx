...
import MessageInputForm from "../components/Chat/MessageInputFor
...
if (selectedUserId) {
try {
const res = await axios.get(`/api/user/messages/${sele
...
...p,
avatarLink: p.avatarLink, // assuming avatarLink is a pr
}));
setOfflinePeople(
...
if (ev) ev.preventDefault();
    ...
    ws.send(JSON.stringify({ text: newMessage, recipient: select
setNewMessage("");
setMessages((prev) => [
  ...prev,
{
...
<ChatMessages
          ...
          selectedUserId={selectedUserId}
/>
<div className="absolute w-full bottom-0 flex justify-ce
<MessageInputForm
