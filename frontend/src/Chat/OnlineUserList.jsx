...
const OnlineUsersList = ({
  ...
  const filteredOnlinePeople = Object.keys(onlinePeople).filter(
    (userId) => {
  ...
  const filteredOfflinePeople = Object.keys(offlinePeople).filter(
    (userId) => {
  ...
  return (
    <section className="w-[29%] py-3 border-r px-2 lg:px-4 border-gray-700">
      <div className="text-white flex items-center gap-2 p-1 px-3 border rounded-lg mb-3">
        <svg
